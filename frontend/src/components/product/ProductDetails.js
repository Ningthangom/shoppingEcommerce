 ...
 import {getProductDetails, clearError, newReview} from '../../action/productActions'
...
const  ProductDetails =({match} ) => {
    ...
    useEffect(() =>{
        // getting the id for product detail
    ...
    // increase the quantity of product that customer want to buy
    const increaseQty =() => {
     ...
     return (
         ...
         {loading ? <Loader/> : (
             ...
             <div className="col-12 col-lg-5 mt-5">
                 ...
                 <p id="product_price">A${product.price}</p>
