...
import {getProductReviews, deleteReview, clearError } from '../../action/productActions'
...
const ProductReviews = () => {
    ...
    return (
        <Fragment>
        <Metadata title={'Reviews of Products'}/>
        <div className="row">
                ...
                <Fragment>
                    ...
                    {reviews && reviews.length > 0 ? (
                               <MDBDataTable 
                                ...
                                hover
                             />  ) : (
                                 <p className="mt-5 text-center">No Review for this product</p>
                             )}
